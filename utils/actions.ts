...
export const fetchFeaturedProducs = async () => {
...
export const createProductAction = async (
  ...
  try {
    ...
    const vaildatedFile = validateWithZodSchema(imageSchema, { image: file });
    const fullPath = await uploadImage(vaildatedFile.image);
